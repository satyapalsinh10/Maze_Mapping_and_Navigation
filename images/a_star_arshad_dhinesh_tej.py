...
if __name__ == "__main__":
    ...
    display_environment = environment(520, 520, obstacle_inflation)
    display_environment.create_map()
    #-------------------------------------------------------------------------------

    _environment = environment(520, 520, robot_radius+obstacle_inflation)
    ...
    #while(not _environment.is_valid_position(start_state)) or start_state[2] % 1 != 0: #check if the start node is outside the map
    ...
    #while(not _environment.is_valid_position(goal_state)) or goal_state[2] % 1 != 0: #check if the goal node is outside the map
